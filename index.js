...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Chocolate \n' 
            + 'ORG: Pengembang ChocoBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6282360929594:+62 823-6092-9594\n' 
            + 'END:VCARD' 
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Ahmad \n' 
            + 'ORG: Pengembang ChocoBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6289637266260:+62 896-3726-6260\n' 
            + 'END:VCARD' 
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Gumilang \n' 
            + 'ORG: Pengembang ChocoBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6289601201936:+62 896-0120-1936\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []          
...
const config = {
    XBOT: '❉Chocolate❉', 
    instagram: 'https://instagram.com/im.chocolates', 
    nomer: 'wa.me/6282360929594',
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@im.chocolates`)
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282360929594@s.whatsapp.net" , "6289601201936@s.whatsapp.net" , "6289637266260@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
				...
				case 'info':
					...
					teks = `*Nama bot* : ${me.name}\n*OWNER* : *Chocolate,Ahmad,Gumilang*\n*Creator* : Chocolate\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total Block Contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}`
                ...
                case 'bug':
                    ...
                    client.sendMessage('6282360929594@s.whatsapp.net', options, text, {quoted: mek})
