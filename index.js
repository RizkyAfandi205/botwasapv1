...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282360929594@s.whatsapp.net" , "6289601201936@s.whatsapp.net" , "6289637266260@s.whatsapp.net" , "6288269147510@s.whatsapp.net" , "6282360533339@s.whatsapp.net" , "6281219130844@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
				...
				case 'info':
					...
					teks = `*Nama bot* : ${me.name}\n*OWNER* : *Chocolate|Ahmad|Gumilang|Reza|Rakha*\n*Creator* : Chocolate\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total Block Contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}`
